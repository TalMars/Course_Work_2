using CourseWork_2.SwipeableSplitViewControl_Folder.Presentation;
using System;
...
namespace CourseWork_2.Pages
{
    ...
    /// </summary>
    public sealed partial class OpenPrototypePage : Page
    {
        ...
        public OpenPrototypePage()
        {
            ...
            //vm.MenuItems.Add(new MenuItem { Icon = "", Title = "WebViewPage", PageType = typeof(WebPrototypeViewPage) });
