            ...
            IResultScreensPage_Bindings
        {
            ...
            private void Update_ViewModel_RingContentVisibility(global::System.Boolean obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    XamlBindingSetters.Set_Windows_UI_Xaml_UIElement_IsHitTestVisible(this.obj7, (global::System.Boolean)this.LookupConverter("inverseBoolConverter").Convert(obj, typeof(global::System.Boolean), null, null));
                }
            }
